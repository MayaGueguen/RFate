...
test_that("POST_FATE.graphic_evolutionPixels gives error with wrong data : name.simulation", {
  ...
  expect_error(POST_FATE.graphic_evolutionPixels("a")
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.graphic_evolutionPixels(factor("A"))
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.graphic_evolutionPixels(data.frame(1))
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
...
## INPUTS
test_that("POST_FATE.graphic_evolutionPixels gives error with wrong data : files", {
  expect_error(POST_FATE.graphic_evolutionPixels(name.simulation = "FATE_simulation"
...
# ## INPUTS
# test_that("POST_FATE.graphic_evolutionPixels gives error with wrong data : rasters", {
...
#                  , fixed = TRUE)
#   
#   expect_output(str(POST_FATE.graphic_evolutionPixels(name.simulation = "FATE_simulation"
#                                                             , file.simulParam = "ParamSimul.txt"
