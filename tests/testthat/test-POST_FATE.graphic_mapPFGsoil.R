...
test_that("POST_FATE.graphic_mapPFGsoil gives error with wrong data : rasters", {
  ...
  expect_error(POST_FATE.graphic_mapPFGsoil(name.simulation = "FATE_simulation"
                                            ...
                                            , strata_min = 1
                                            , mat.PFG.succ = data.frame(PFG = 1, soil_contrib = 1))
               , "Missing data!\n `mat.PFG.succ` does not contain soil value for the PFG `Hop`. Please check."
               , fixed = TRUE)
  ...
  expect_message(POST_FATE.graphic_mapPFGsoil(name.simulation = "FATE_simulation"
                                              ...
                                              , year = 10
                                              , strata_min = 1
                                              , mat.PFG.succ = data.frame(PFG = "Hop", soil_contrib = 1))
                 , "has been successfully created !"
                 , fixed = TRUE)
  
  expect_warning(POST_FATE.graphic_mapPFGsoil(name.simulation = "FATE_simulation"
                                              , file.simulParam = "ParamSimul.txt"
                                              , year = 10
                                              , strata_min = 1
                                              , mat.PFG.succ = data.frame(PFG = "Hop", soil_contrib = 1))
  ...
  expect_output(str(POST_FATE.graphic_mapPFGsoil(name.simulation = "FATE_simulation"
                                                 , file.simulParam = "ParamSimul.txt"
                                                 , year = 10
                                                 , strata_min = 1
                                                 , mat.PFG.succ = data.frame(PFG = "Hop", soil_contrib = 1))), "list")
})
