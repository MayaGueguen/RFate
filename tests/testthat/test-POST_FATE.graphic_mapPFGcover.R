...
## OUTPUTS
# test_that("POST_FATE.graphic_mapPFGcover gives right output", {
#   data(MontBlanc)
...
# 
#   expect_output(str(POST_FATE.graphic_mapPFGcover(clust.dendograms = sp.CLUST$clust.dendograms[[1]]
#                                                 , no.clusters = 11
#                                                 , mat.species.DIST = sp.DIST[[1]])), "List")
#   expect_output(str(POST_FATE.graphic_mapPFGcover(clust.dendograms = sp.CLUST$clust.dendograms[[1]]
#                                                      , no.clusters = 11
#                                                      , mat.species.DIST = sp.DIST[[1]])[[2]]), "10 variables")
#   expect_equal(length(POST_FATE.graphic_mapPFGcover(clust.dendograms = sp.CLUST$clust.dendograms[[1]]
#                                                      , no.clusters = 11
#                                                      , mat.species.DIST = sp.DIST[[1]])), 2)
#   
#   expect_output(str(POST_FATE.graphic_mapPFGcover(clust.dendograms = sp.CLUST$clust.dendograms
#                                                      , no.clusters = c(11, 7, 8)
#                                                      , mat.species.DIST = sp.DIST)), "List")
#   expect_output(str(POST_FATE.graphic_mapPFGcover(clust.dendograms = sp.CLUST$clust.dendograms
#                                                      , no.clusters = c(11, 7, 8)
#                                                      , mat.species.DIST = sp.DIST)[[2]]), "10 variables")
#   expect_equal(length(POST_FATE.graphic_mapPFGcover(clust.dendograms = sp.CLUST$clust.dendograms
#                                                        , no.clusters = c(11, 7, 8)
