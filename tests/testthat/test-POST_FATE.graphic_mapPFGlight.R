...
## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with missing data", {
  expect_error(POST_FATE.graphic_mapPFGlight()
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.graphic_mapPFGlight(NA)
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.graphic_mapPFGlight(NULL)
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
})

## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with wrong data : name.simulation", {
  expect_error(POST_FATE.graphic_mapPFGlight(1)
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.graphic_mapPFGlight("a")
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.graphic_mapPFGlight(factor("A"))
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.graphic_mapPFGlight(data.frame(1))
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
...
## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with wrong data : file.simulParam", {
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
...
## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with wrong data : year", {
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = "a")
               , "Wrong type of data!\n `year` must be an integer > 0")
...
## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with wrong data : mat.PFG.succ", {
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = NA)
  ...
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
               ...
               , "`mat.PFG.succ` does not have the appropriate number of rows (>0) or columns (PFG, light)", fixed = T)
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
  ...
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = data.frame(PFG = 1, light = c(1,1)))
               , "Column `PFG` of `mat.PFG.succ` must contain different values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = data.frame(PFG = NA, light = 1))
               , "Column `PFG` of `mat.PFG.succ` must contain different values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = data.frame(PFG = c(1,NA), light = 1))
               , "Column `PFG` of `mat.PFG.succ` must contain different values")
  
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = data.frame(PFG = "", light = 1))
               , "`mat.PFG.succ$PFG` must contain a character value of length > 0", fixed = T)
  
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = data.frame(PFG = 1, light = NA))
               , "Columns `light` of `mat.PFG.succ` must contain numeric values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = data.frame(PFG = 1, light = "a"))
               , "Columns `light` of `mat.PFG.succ` must contain numeric values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = data.frame(PFG = 1, light = factor(1)))
               , "Columns `light` of `mat.PFG.succ` must contain numeric values")
  
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , mat.PFG.succ = data.frame(PFG = c(1,2), light = c(2, NA)))
               , "Columns `light` of `mat.PFG.succ` must not contain NA values")
})


## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with wrong data : strata_min", {
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = "a")
...
## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with wrong data : opt.mat.light.obs", {
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
                                             ...
                                             , opt.mat.light.obs = "a")
               , "Wrong type of data!\n `opt.mat.light.obs` must be a data.frame")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = factor("a"))
               , "Wrong type of data!\n `opt.mat.light.obs` must be a data.frame")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
  ...
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             ...
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = data.frame(1))
               , "Wrong dimension(s) of data!\n `opt.mat.light.obs` does not have the appropriate number of rows (>0) or columns (X, Y, obs)"
               , fixed = TRUE)
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = data.frame(1, 2, 3))
               , "Wrong type of data!\n Column names of `opt.mat.light.obs` must be `X`, `Y` and `obs`")
  ...
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             ...
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = data.frame(X = "a", Y = 2, obs = 3))
               , "Wrong type of data!\n Columns `X`, `Y` and `obs` of `opt.mat.light.obs` must contain numeric values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = data.frame(X = factor(1), Y = 2, obs = 3))
               , "Wrong type of data!\n Columns `X`, `Y` and `obs` of `opt.mat.light.obs` must contain numeric values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = data.frame(X = 1, Y = "a", obs = 3))
               , "Wrong type of data!\n Columns `X`, `Y` and `obs` of `opt.mat.light.obs` must contain numeric values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = data.frame(X = 1, Y = factor(1), obs = 3))
               , "Wrong type of data!\n Columns `X`, `Y` and `obs` of `opt.mat.light.obs` must contain numeric values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = data.frame(X = 1, Y = 2, obs = "a"))
               , "Wrong type of data!\n Columns `X`, `Y` and `obs` of `opt.mat.light.obs` must contain numeric values")
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
                                             , mat.PFG.succ = data.frame(PFG = 1, light = 1)
                                             , opt.mat.light.obs = data.frame(X = 1, Y = 2, obs = factor(1)))
               , "Wrong type of data!\n Columns `X`, `Y` and `obs` of `opt.mat.light.obs` must contain numeric values")
})


## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with wrong data : opt.ras.light.obs", {
...
## INPUTS
test_that("POST_FATE.graphic_mapPFGlight gives error with wrong data : files", {
  expect_error(POST_FATE.graphic_mapPFGlight(name.simulation = "FATE_simulation"
                                             , file.simulParam = "ParamSimul.txt"
                                             , year = 10
                                             , strata_min = 2
