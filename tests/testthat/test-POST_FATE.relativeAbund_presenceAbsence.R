library(RFate)
context("POST_FATE.relativeAbund_presenceAbsence() function")


## INPUTS
test_that("POST_FATE.relativeAbund_presenceAbsence gives error with missing data", {
  expect_error(POST_FATE.relativeAbund_presenceAbsence()
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.relativeAbund_presenceAbsence(NA)
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.relativeAbund_presenceAbsence(NULL)
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
})

## INPUTS
test_that("POST_FATE.relativeAbund_presenceAbsence gives error with wrong data : name.simulation", {
  expect_error(POST_FATE.relativeAbund_presenceAbsence(1)
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.relativeAbund_presenceAbsence("a")
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.relativeAbund_presenceAbsence(factor("A"))
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
  expect_error(POST_FATE.relativeAbund_presenceAbsence(data.frame(1))
               , "Wrong name folder given!\n `name.simulation` does not exist or does not contain a PARAM_SIMUL/ folder")
...
## INPUTS
test_that("POST_FATE.relativeAbund_presenceAbsence gives error with wrong data : file.simulParam", {
  expect_error(POST_FATE.relativeAbund_presenceAbsence(name.simulation = "FATE_simulation"
...
## INPUTS
test_that("POST_FATE.relativeAbund_presenceAbsence gives error with wrong data : year", {  
  expect_error(POST_FATE.relativeAbund_presenceAbsence(name.simulation = "FATE_simulation"
                                                       , file.simulParam = "ParamSimul.txt"
                                                       , year = "a")
               , "Wrong type of data!\n `year` must be an integer > 0")
...
test_that("POST_FATE.relativeAbund_presenceAbsence gives error with wrong data : outputs", {
  ...
  #                                                            , year = 10)
  #                    , "FATE_simulation/RESULTS/Hello/ABUND_REL_perPFG_allStrata/Abund_relative_YEAR_10_PFG1_STRATA_all.txt"
  #                    , fixed = TRUE)
})
