...
getTraits_1_removeUninformative = function(traits)
{
  ...
  ind.noValue1 = which(is.na(traits$valeur) & is.na(traits$nom))
  ind.noValue2 = which(is.na(traits$valeur) & nchar(traits$nom) == 0)
  ind.noValue = sort(unique(c(ind.noValue1, ind.noValue2)))
...
getTraits_5_reorganize = function(traits.quant, traits.quali) #, TRAIT_names)
{
