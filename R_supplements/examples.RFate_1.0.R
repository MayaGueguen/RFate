...
tt = PNE_PFG$sp.observations[, c("sites", "species", "abund", "habitat")]
tt = tt[sample(1:nrow(tt), 10000), ]
fwrite(tt, file = "TEST_tab_obs.csv")
fwrite(PNE_PFG$dom.traits, file = "TEST_tab_traits.csv")
tt = PNE_PFG$dom.dist_overlap
save(tt, file = "TEST_tab_overlap.RData")
