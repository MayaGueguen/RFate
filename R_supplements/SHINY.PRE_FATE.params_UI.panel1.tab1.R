...
tabPanel(title = HTML("<span class='tabPanel_title'>Dominant species</span>")
         ...
         , fluidRow(
           column(6
                  ...
                  , sliderInput(inputId = "selectionRule.quanti"
                                , label = param.style("selectionRule.quanti")
                                , min = 0
                                , max = 1
                                , value = 0.8
                                , step = 0.05
                  ...
                  , numericInput(inputId = "selectionRule.min_mean_abund"
                                 , label = param.style("selectionRule.min_mean_abund")
                                 , min = 0
                                 , value = 10
                                 , step = 1
                                 , width = "100%")
                  , numericInput(inputId = "selectionRule.min_no_abund_over25"
                                 , label = param.style("selectionRule.min_no_abund_over25")
                                 , min = 0
                                 , value = 10
                                 , step = 1
                                 , width = "100%")
