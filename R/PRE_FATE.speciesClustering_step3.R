...
##'   fecundity of the PFG within \code{FATE} (see XXX, CORE module) \cr
...
##'   limits of strata in \code{FATE} (see XXX, LIGHT competition module)}
...
##'   within \code{FATE} (see XXX, SOIL competition module)}
