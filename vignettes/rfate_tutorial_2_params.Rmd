...
This is the file that will be given as the only argument to the `FATE` executable file into the command line.  
...
Folders can be created with the function [PRE_FATE.params_multipleSet](https://mayagueguen.github.io/RFate/reference/PRE_FATE.params_multipleSet.html)
