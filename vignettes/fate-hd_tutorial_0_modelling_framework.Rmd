---
title: "FATE-HD tutorial 0 - Modelling framework"
---
...
<div style = "text-align:center;">See [Boulangeat, 2014](papers/Boulangeat_2014_GCB.pdf "Boulangeat, I., Georges, D., Thuiller, W., FATE-HD: A spatially and temporally explicit integrated model for predicting vegetation structure and diversity at regional scale. Global Change Biology, 20, 2368–2378.") or the [Publications](fate-hd_tutorial_0_publications.html) page</div>
...
- **<i class="fas fa-seedling"></i> The seed dispersal model** makes `FATE-HD` spatially explicit by connecting grid-cells.  
...
## <i class="fas fa-code"></i> Class diagram
